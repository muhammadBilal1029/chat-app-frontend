      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign up to start chatting with your team</p>
          </div>
          ...
          <form onSubmit={register} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full text-black px-4 py-3 rounded-xl border-2 transition-all duration-200 focus:outline-none focus:ring-2 ${
                  errors.name
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full text-black px-4 py-3 rounded-xl border-2 transition-all duration-200 focus:outline-none focus:ring-2 pr-12 ${
                    errors.password
                      ? 'border-red-500 focus:border-red-500 focus:ring-red-200'
                      : 'border-gray-300 focus:border-blue-500 focus:ring-blue-200'
                  }`}
